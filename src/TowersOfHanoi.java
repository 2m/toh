...
public class TowersOfHanoi extends JPanel
{
    ...
    public static void addComponentsToPane(Container pane) {
        ...
        step = new JButton("Vienas žingsnis");
            ...
            public void actionPerformed(ActionEvent ae) {
                if (!doContinue) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(frame, "Žingsnio intervalas turi būti didesnis arba lygus nuliui.", "Netinkamas žingsnio intervalas", JOptionPane.ERROR_MESSAGE);
                    }
                }
                else {
                    ((JButton)ae.getSource()).setText("Tęsti");
        ...
        JButton reset = new JButton("Iš naujo");
        reset.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "Diskų skaičius turi būti tarp 0 ir 100.", "Netinkamas diskų skaičius", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        p.add(reset);
        ...
        p.add(new JLabel("Pradinis diskų skaičius:"));
        p.add(diskNumber);

        done = new JLabel("Išspręsta");
        done.setOpaque(true);
